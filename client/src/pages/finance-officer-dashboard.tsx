              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-green-600 dark:text-green-400">
                    {user?.organizationId ? `Org ${user.organizationId}` : 'Not Set'}
                  </p>
                </div>
              </div>
            </CardContent>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div>
                      <h3 className="font-medium">Settlement Capacity</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Available funds for settlement requests
                      </p>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-4 border border-gray-200 dark:border-gray-700 rounded-lg">
                    <div>
                      <h3 className="font-medium">Organization Merchants</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Active merchant accounts under your organization
                      </p>
                    </div>
                    <div className="text-right">
